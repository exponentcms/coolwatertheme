...
<html>
	...
	<body>
		...
		<div id="wrap" class="fullbody">
			<!--header -->
			<div id="header">			
                <div id="logo-text"><a href="<?php echo URL_FULL; ?>index.php" title="<?php echo SITE_TITLE; ?>"><span class="green"><?php if(LOGO_TEXT_MAIN=='') echo ORGANIZATION_NAME; else echo LOGO_TEXT_MAIN; ?></span> <sup><?php echo LOGO_TEXT_SUPERSCRIPT; ?></sup></a></div>
